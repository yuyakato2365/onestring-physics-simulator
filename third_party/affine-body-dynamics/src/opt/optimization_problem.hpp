...
public:
    ...
    virtual const Eigen::MatrixXd& unconstrained_basis() = 0;

    virtual Eigen::VectorXd enforce_linear_constraint(Eigen::VectorXd x) = 0;

    virtual Eigen::VectorXd linear_constraint_error(Eigen::VectorXd x) = 0;
    ...
    virtual bool has_linear_constraints() const { return false; }
};
