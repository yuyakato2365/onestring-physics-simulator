    ...
    size_t edgeB_id)              // In bodyB
{
    ...
    std::cerr << fmt_eigen(poseA_t0.transform) << std::endl;
    std::cerr << fmt_eigen(poseA_t1.position) << std::endl;
    std::cerr << fmt_eigen(poseA_t1.transform) << std::endl;
    ...
    std::cerr << fmt_eigen(poseB_t0.transform) << std::endl;
    std::cerr << fmt_eigen(poseB_t1.position) << std::endl;
    std::cerr << fmt_eigen(poseB_t1.transform) << std::endl;
    std::cerr << std::endl;
}
