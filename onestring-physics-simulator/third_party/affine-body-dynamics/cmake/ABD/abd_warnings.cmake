...
add_library(abd_warnings INTERFACE)
add_library(abd::abd::warnings ALIAS abd_warnings)

foreach(FLAG IN ITEMS ${ABD_FLAGS})
    ...
    if(IS_SUPPORTED_${FLAG_VAR})
        target_compile_options(abd_warnings INTERFACE ${FLAG})
    endif()
endforeach()
