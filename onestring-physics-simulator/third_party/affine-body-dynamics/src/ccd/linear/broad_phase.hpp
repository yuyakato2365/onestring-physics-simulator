...
// @javidf: not sure if this method is needed. PLEASE REVISE.
// Discontineous collision detection. A single pose is needed.
...
// /// @brief Use the three level ABD broad-phase to set cadidate collisions.
...
// @javidf: not sure if this method is necessary. PLEASE REVISE.
// Discontineous collision detection. A single pose is needed
/// @brief Use the three level ABD broad-phase to set cadidate collisions.
void detect_collision_candidates_linear_bvh(
    const RigidBodyAssembler& bodies,
...
// void detect_collision_candidates_iaabb2(
//     const RigidBodyAssembler& bodies,
//     const PosesD& poses_t0,
//     const PosesD& poses_t1,
//     const int collision_types,
