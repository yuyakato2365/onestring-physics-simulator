...
if view_stage == "Pipeline View":
    ...
    st.plotly_chart(figure_quad_mesh(mesh, title=view_stage), use_container_width=True, key=f"mesh_{view_stage}")
    if view_stage == "K3D":
    ...
    st.plotly_chart(figure_m3d_overlay(state), use_container_width=True, key="mesh_M3D")
    ...
    st.plotly_chart(figure_tile_assembly(state.tiles_2d_top_hinge, hinge_graph=top_hinge_graph), use_container_width=True, key="t2d_top")
    ...
    st.plotly_chart(figure_tile_assembly(state.tiles_2d_dual_hinge, hinge_graph=state.hinge_graph), use_container_width=True, key="t2d_dual")
