...
The execution path is patched in three layers:
1) semantic Split/Panel behavior,
2) direct wiring into legacy build-function globals,
3) a final M2D topology pass that force-disconnects every reported split line
   before M2D is returned downstream.
"""
